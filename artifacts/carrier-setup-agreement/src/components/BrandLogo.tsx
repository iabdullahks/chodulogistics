export default function BrandLogo({ size = 56 }: { size?: number }) {
  return (
    ...
    >
      {/* Outer ring */}
      <circle cx="28" cy="28" r="27" stroke="#D4AF37" strokeWidth="1.5" fill="#0d0d0d" />
      {/* Inner circle accent */}
      <circle cx="28" cy="28" r="22" stroke="#D4AF37" strokeWidth="0.5" strokeDasharray="3 3" fill="none" />

      {/* Road / highway lines */}
      <rect x="12" y="32" width="32" height="2" rx="1" fill="#D4AF37" opacity="0.4" />
      <rect x="26" y="29" width="2" height="8" rx="1" fill="#D4AF37" opacity="0.6" />
      ...
      <circle cx="20" cy="18" r="1" fill="#D4AF37" opacity="0.8" />
      <circle cx="28" cy="15" r="1" fill="#D4AF37" opacity="0.8" />
      <circle cx="36" cy="18" r="1" fill="#D4AF37" opacity="0.8" />
    </svg>
  )
}
