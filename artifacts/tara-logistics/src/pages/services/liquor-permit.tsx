            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <div className="prose prose-invert max-w-none text-muted-foreground text-lg leading-relaxed space-y-6 font-light">
                  ...
                  <p>
                    Tara Logistics holds direct relationships with major beverage distributors and shippers. We connect permitted carriers with steady volume lanes, and we help non-permitted carriers obtain the necessary licenses to enter this lucrative market.
                  </p>
                </div>
              </section>
