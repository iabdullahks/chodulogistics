            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <div className="prose prose-invert max-w-none text-muted-foreground text-lg leading-relaxed space-y-6 font-light">
                  <p>
                    For owner-operators and small fleets, trailer ownership is a significant barrier to entry for higher-paying, specialized freight. Tara Logistics' Rented Trailer Program is designed to remove that barrier, offering flexible access to well-maintained equipment.
                  </p>
                  <p>
